...
[task_local]
#发财大赢家
20 * * * * jd_big_winner.js, tag=发财大赢家, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

=================================Loon===================================
[Script]
cron "20 * * * *" script-path=jd_big_winner.js,tag=发财大赢家

===================================Surge================================
发财大赢家 = type=cron,cronexp="20 * * * *",wake-system=1,timeout=3600,script-path=jd_big_winner.js

====================================小火箭=============================
发财大赢家 = type=cron,script-path=jd_big_winner.js, cronexpr="20 * * * *", timeout=3600, enable=true
 */
const $ = new Env('发财大赢家');

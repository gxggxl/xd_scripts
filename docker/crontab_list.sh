...
# 双11星推官 (11.10 结束)
21 3,4,15 * * * node /scripts/jd_xtg.js >> /scripts/logs/jd_xtg.log 2>&1
# 潮玩儿制躁团 (11.14 结束)
...
# 发财大赢家之翻翻乐
13,37 0-13 * * * node /scripts/jd_big_winner.js >> /scripts/logs/jd_big_winner.log 2>&1
...
#京东保价
5 10,22 * * * node /scripts/jd_price.js >> /scripts/logs/jd_price.log 2>&1

...
# 集魔方 (京东APP - 新品 - 集魔方)
16 0,13 * * * node /scripts/jd_mofang.js >> /scripts/logs/jd_mofang.log 2>&1
# 明星小店(星店长)9.18-10.9
...
21 0,10,16,21 * * * node /scripts/jd_speed_redpocke.js >> /scripts/logs/jd_speed_redpocke.log 2>&1
...
# 特物Z 活动时间：
5 13,18,22 * * * node /scripts/jd_superBrand.js >> /scripts/logs/jd_superBrand.log 2>&1
...
# 京喜财富岛
13 0,6-23/2 * * * node /scripts/jd_cfd.js >> /scripts/logs/jd_cfd.log 2>&1
# 京喜财富岛互助
...
###################### 敏感操作 ######################
# 过期京豆兑换喜豆
22 21 * * * node /scripts/jd_exchangejxbeans.js >> /scripts/logs/jd_exchangejxbeans.log 2>&1
# 取关主播
21 22 * * * node /scripts/jd_unsubscriLive.js >> /scripts/logs/jd_unsubscriLive.log 2>&1
# 取关京东店铺商品

...
let cookiesArr = [], cookie = '', message, shareCodeInfo;
 shareCodeInfo = `互助码\n提交机器人 @JD_ShareCode_Bot\n\n`
...
function shareCodeinfo() {
  ...
  if ($.index === (cookiesArr.length)){
    shareCodeInfo += `/bean ${$.myPlantUuids}\n`
    shareCodeInfo += `/farm ${$.farmsinfo}\n`
    shareCodeInfo += `/jxfactory ${$.encryptPins}\n`
    shareCodeInfo += `/pet ${$.pets}\n\n`
  }
}
